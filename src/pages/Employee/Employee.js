...
const Employee = () => {
    ...
    const fetchData = (currenPage)=>{
        fetch(
            `https://60f2479f6d44f300177885e6.mockapi.io/users?user_type=employee&page=${currenPage}&limit=5`
    ...
    useEffect(()=> {
        fetch('https://60f2479f6d44f300177885e6.mockapi.io/users?user_type=employee&page=1&limit=5')
        .then(res=> res.json())
